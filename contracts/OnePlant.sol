...
contract Prometheans {
    ...
    function tokenURI(uint256 id) public view virtual returns (string memory) {
        ...
        return string(abi.encodePacked("https://one-plant.coinplants.io/nft", _toString(id), "/", _toString(token.moisture), "/", _toString(token.mintingBlock + MATURITY)));
    }
    ...
    function _mint(address to, uint256 id, uint256 moisture) internal virtual {
        require(to != address(0), "INVALID_RECIPIENT");
